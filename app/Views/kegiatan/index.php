                        ...
                        <div class="card-body">
                            ...
                            <body>
                                <div class="container">
                                    <div class="">
                                        <div class="">
                                            <a href="/kegiatan/create" class="btn btn-primary mb-3">Tambah</a>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $no = 1;
                                                    foreach ($kegiatannn as $kegiatan_) :
                                                    ?>
                                                        <tr>
                                                            <th><?= $no; ?></th>
                                                            <td><img style="width: 120px;" src="<?= base_url('gambar/' . $kegiatan_->foto_flyer); ?>" alt=""></td>
                                                            <td><?= $kegiatan_->judul; ?></td>
                                                            <td><?= $kegiatan_->narasumber; ?></td>
                                                            <td>
                                                                <a title="Delete" href="<?= base_url("/kegiatan/detail/$kegiatan_->id"); ?>" class="btn btn-success">Detail</a>
                                                            </td>
                                                        </tr>
