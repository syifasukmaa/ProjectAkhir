                        ...
                        <div class="card-body">
                            ...
                            <body>
                                <div class="container">
                                    <div class="">
                                        <div class="">
                                            <a href="/KategoriPeserta/create" class="btn btn-primary mb-3">Tambah</a>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a title="Delete" href="<?= base_url("/KategoriPeserta/delete/$kategori->id"); ?>" class="btn btn-danger">Delete</a>
                                                                <a title="Edit" href="<?= base_url("/KategoriPeserta/edit/$kategori->id"); ?>" class="btn btn-info">Edit</a>
                                                            </td>
                                                        </tr>
