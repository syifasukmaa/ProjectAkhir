                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <body>
                                <div class="container">
                                    <a href="/daftar/create" class="btn btn-primary mb-3">Tambah</a>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            foreach ($daftar as $daftar_) :
                                            ?>
                                                <tr>
                                                    <td><?= $no; ?></td>
                                                    <td><?= $daftar_->tanggal_daftar; ?></td>
                                                    <td><?= $daftar_->alasan; ?></td>
                                                    <td><?= $daftar_->users_id; ?></td>
                                                    <td><?= $daftar_->kegiatan_id; ?></td>
                                                    <td><?= $daftar_->kategori_peserta_id; ?></td>
                                                    <td><?= $daftar_->nosertifikat; ?></td>
                                                    <td>
                                                        <a title="Delete" href="<?= base_url("/daftar/delete/$daftar_->id"); ?> " class="btn btn-danger ">Delete</a>

                                                        <a title="Edit" href="<?= base_url("/daftar/edit/$daftar_->id"); ?>" class="btn btn-info  mt-2">Edit</a>
                                                    </td>
                                                </tr>
