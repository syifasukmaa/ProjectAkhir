                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Tambah Daftar</h3>
                        </div>
                        <div class="card-body">
                            <!DOCTYPE html>
                            <html lang="en">
                                    ...
                                    <div class="card-body">
                                        <form action="daftar/save" method="POST">
                                            ...
                                            <div class="form-group mt-3">
                                                ...
                                                <input type="text" id="kegiatan_id" name="kegiatan_id" class="form-control">
                                            </div>
                                            <div class="form-group mt-3">
                                                <label for="kategori_peserta_id">Kategori Peserta ID</label>
                                                <input type="text" id="kategori_peserta_id" name="kategori_peserta_id" class="form-control">
                                            </div>
                                            <div class="form-group mt-3">
                                                <label for="nosertifikat">No Sertifikat</label>
                                                <input type="text" id="nosertifikat" name="nosertifikat" class="form-control">
                                            </div>
