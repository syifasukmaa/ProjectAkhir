        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block ms-3">
                    <a href="<?= base_url('login/logout'); ?>" class="btn btn-danger text-light nav-link active"><b>LOGOUT</b></a>
                </li>
                <li class="nav-item d-none d-sm-inline-block ms-3">
                    <a href="<?= base_url('landingpage'); ?>" class="btn btn-primary text-light nav-link active"><b>DASHBOARD</b></a>
                </li>
            </ul>
